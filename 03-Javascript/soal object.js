...
// Filter array product dengan harga di bawah 300000 menggunakan array filter
...
// Filter: hanya tampilkan produk dengan harga KURANG dari 300000 (strict <)
const murah = products.filter((product) => product.price < 300000);
